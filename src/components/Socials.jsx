...
const Socials = () => {
    ...
    useEffect(() => {
        ...
        const currentViews = storedViews ? parseInt(storedViews) : 1200;
    ...
    const socialLinks = [
        ...
        },
        {
            ...
            url: `${import.meta.env.BASE_URL}Ajay_Patel_Resume.pdf`,
            className: 'resume'
        }
    ];
                    ...
                    {socialLinks.map((link, index) => {
                        ...
                        return (
                            <a
                                ...
                                rel="noreferrer"
                                download={isResume ? "Ajay_Patel_Resume.pdf" : undefined}
