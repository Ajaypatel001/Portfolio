        ...
        <div className="about-content">
          <div className="about-text">
            ...
            <p>
              ...
              I have built multiple hands-on projects across <strong>web development, cloud, and DevOps</strong>,
              gaining practical experience in developing scalable and secure applications.
            </p>

            <p>
              I am a <strong>continuous learner</strong> who is always exploring new tools and technologies
              to enhance my expertise and grow as a <strong>Cloud & DevOps professional</strong>.
            </p>
